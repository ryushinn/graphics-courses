...
function GAMES202Main() {
	...
	const directionLight2 = new DirectionalLight(2500, [1, 1, 1], [80, 80, -40], focalPoint, lightUp, true, renderer.gl);
	...
	loadOBJ(renderer, 'assets/mary/', 'Marry', 'PhongMaterial', obj1Transform, animated = true);
