					...
					object.traverse(function (child) {
						if (child.isMesh) {
							...
							switch (objMaterial) {
								...
								case 'PRTMaterial':
									albedo = 0.5;
									let color = vec3.fromValues(albedo, albedo, albedo);
									material = buildPRTMaterial(color, './src/shaders/PRTShader/PRTVertex.glsl', './src/shaders/PRTShader/PRTFragment.glsl');
									break;
