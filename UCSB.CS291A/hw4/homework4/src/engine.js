...
// 1. the white furnace test switch button: true - on, false - off;
let wft = false;

// 2. several pairs of r and edgetints from the paper[Conductor Fresnel - Gulbrandsen, 2014]
// all in linear space
// White: for test
// let r = [1.0, 1.0, 1.0];
// let edgetint = [1.0, 1.0, 1.0];

// Copper  
let r = [Math.pow(0.7216, 2.2), Math.pow(0.451, 2.2), Math.pow(0.2, 2.2)];
let edgetint = [0.827, 0.792, 0.678];

// Copper from the paper:
// let r = [0.8433, 0.4368, 0.2195];
// let edgetint = [0.9918, 0.8831, 0.6455];

// gold from the paper:
// let r = [0.8831, 0.4995, 0.1139]
// let edgetint = [0.9913, 0.9406, 0.5054];
